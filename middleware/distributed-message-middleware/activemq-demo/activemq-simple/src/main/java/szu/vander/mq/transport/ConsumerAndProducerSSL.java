...
public class ConsumerAndProducerSSL {
    public static void main(String[] args) {
        ...
        try {
            // 1、创建连接工厂
            connectionFactory = new ActiveMQSslConnectionFactory("ssl://192.168.125.233:61617?socket.verifyHostName=false");
            ...
            // 4、创建点对点接收的目标
            Destination destination = session.createQueue("ssl-queue");
            // 5、创建生产者消息
